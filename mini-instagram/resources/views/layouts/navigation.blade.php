<nav x-data="{ open: false }" class="bg-white dark:bg-gray-700 border-b border-gray-50 dark:border-gray-800">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                    <x-nav-link :href="route('posts.create')" :active="request()->routeIs('posts.create')" class="flex items-center space-x-2">
